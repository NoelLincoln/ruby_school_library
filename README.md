...
```sh
  cd my-folder
  git clone https://github.com/NoelLincoln/ruby_school_library.git
```
...
Feel free to check the [issues page](https://github.com/NoelLincoln/ruby_school_library.git/issues).
